		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									...
									<li class="">
										<a href="/admin/mobile-menu-1.html">
											<i class="menu-icon fa fa-caret-right"></i>
											Mobile Menu 1
										</a>
									...
									<li class="">
										<a href="/admin/mobile-menu-2.html">
											<i class="menu-icon fa fa-caret-right"></i>
											Mobile Menu 2
										</a>
									...
									<li class="">
										<a href="/admin/mobile-menu-3.html">
											<i class="menu-icon fa fa-caret-right"></i>
											Mobile Menu 3
										</a>
					...
					<li class="">
						<a href="/admin/flink/index" class="dropdown-toggle">
							<i class="menu-icon fa fa-list"></i>

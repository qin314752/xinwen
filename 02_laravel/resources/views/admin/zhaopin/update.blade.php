...
<form action="{{url('/admin/zhaopin/upload')}}"  method="post" enctype="multipart/form-data">
                    ...
                    <a href="/admin/zhaopin/index" style="position: absolute;top: 10px;right: 60px;font-size: 15px;">返回</a> 

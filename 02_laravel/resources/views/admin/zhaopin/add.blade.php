...
@endif
<br>
<h3 style="margin-left: 100px;margin-bottom: 30px">招聘添加</h3>
<!-- <div class="center"> -->
<form action="{{url('/admin/zhaopin/insert')}}" method="post"  enctype="multipart/form-data" id="validation-form" class="form-horizontal" novalidate="novalidate">	
<dl class="line">
  <dt>分类：</dt>
  <dd>
    <select class="col-xs-12 col-sm-4"  id="form-field-select-1" name="pid" class="form-control">
        <option >顶级分类</option>
        @foreach($arr as $v)
...
<dl class="line">
  <dt>职位名称:</dt>
  <dd>
    <input value="" id="managerName" class="input" name="name" size="40" onclick="document.getElementById('namesnone').style.display='none';document.getElementById('namenone').style.display='none';" type="text">
    <span>一经创建，不可更改！</span>
  </dd>
</dl>
...
<dl class="line">
  <dt>地址位置：</dt>
  <dd>
    <input value="" id="managerName" class="input" name="address" size="40" onclick="document.getElementById('namesnone').style.display='none';document.getElementById('namenone').style.display='none';" type="text">
    <span>一经创建，不可更改！</span>
  </dd>
</dl>
<dl class="form-group" -style="border:1px solid red;">
	  <dt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址位置图片:</dt>
	  <dd>
...
<dl class="form-group" -style="border:1px solid red;">
	  ...
	  <dd>
	   ...
	   <!--  <div class="form-group"  >
	        <label for="name" style="width:330px;" class=" col-xs-3 control-label  no-padding-right">招聘内容:</label>
	        <div >
...
<!-- 
	    <div class="form-group">
	        <label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">职位名称:</label>
	   ...
	   <!--  <div class="form-group">
	    ...
	    {{csrf_field()}}
	    <div class="form-group ">
	        <label for="url" style="width:430px; " class="control-label col-xs-0 no-padding-right"></label>
	        <div class="col-xs-1">
	            <div class="clearfix">

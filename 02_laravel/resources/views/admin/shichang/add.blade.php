...
@endif
<br>
<h3 style="margin-left: 500px;margin-bottom: 30px">市场分析添加</h3>
<!-- <div class="center"> -->
<form action="{{url('/admin/shichang/insert')}}" method="post"  enctype="multipart/form-data" id="validation-form" class="form-horizontal" novalidate="novalidate">	
...
<br>
	...
	<div class="form-group" -style="border:1px solid red;">
            <label   for="form-input-readonly" class="col-sm-3 control-label no-padding-right"> 市场分析图片: </label>
	    ...
	    <div class="form-group"  >
	        <label for="name" style="width:370px;" class=" col-xs-3 control-label  no-padding-right">市场分析:</label>
	        <div >

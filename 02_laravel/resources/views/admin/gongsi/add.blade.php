...
@endif
<br>
<h3 style="margin-left: 30%;margin-bottom: 30px">公司信息添加</h3>
<!-- <div class="center"> -->
<form action="{{url('/admin/gongsi/insert')}}" method="post"  enctype="multipart/form-data" id="validation-form" class="form-horizontal" novalidate="novalidate">	
...
<br>
	...
	<div class="form-group" -style="border:1px solid red;">
            <label   for="form-input-readonly" class="col-sm-3 control-label no-padding-right"> 公司信息图片: </label>
	    ...
	    <div class="form-group"  >
	        <label for="name" style="width:25%;" class=" col-xs-3 control-label  no-padding-right">公司信息:</label>
	        <div >
	    ...
	    {{csrf_field()}}
	    <div class="form-group ">
	        <label for="url" style="width:35%; " class="control-label col-xs-4 no-padding-right"></label>
	        <div class="col-xs-3">
	            <div class="clearfix">

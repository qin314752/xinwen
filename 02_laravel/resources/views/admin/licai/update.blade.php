...
<form action="{{url('/admin/licai/upload')}}"  method="post" enctype="multipart/form-data">
                    ...
                    <a href="/admin/licai/index" style="position: absolute;top: 10px;right: 60px;font-size: 15px;">返回</a> 

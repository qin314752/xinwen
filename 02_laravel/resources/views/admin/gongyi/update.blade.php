...
<form action="{{url('/admin/gongyi/upload')}}"  method="post" enctype="multipart/form-data">
                    ...
                    <a href="/admin/gongyi/index" style="position: absolute;top: 10px;right: 60px;font-size: 15px;">返回</a> 

...
<h3 style="margin-left: 500px;margin-bottom: 30px">社会公益添加</h3>
<!-- <div class="center"> -->
<form action="{{url('/admin/gongyi/insert')}}" method="post"  enctype="multipart/form-data" id="validation-form" class="form-horizontal" novalidate="novalidate">	
	    ...
	    <div class="form-group">
	        <label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">公益组织:</label>
	        <div class="col-xs-12 col-sm-9">
	            <div class="clearfix">
	                <input type="text" class="col-xs-12 col-sm-4" value="{{old('name')}}" name="zuzhi"></div>
	        </div>
	    </div>
	    
	<div class="form-group" -style="border:1px solid red;">
            <label   for="form-input-readonly" class="col-sm-3 control-label no-padding-right"> 公益图片: </label>
	    ...
	    <div class="form-group"  >
	        <label for="name" style="width:25%;" class=" col-xs-3 control-label  no-padding-right">社会公益内容:</label>
	        <div >
	    ...
	    {{csrf_field()}}
	    <div class="form-group ">
	        <label for="url" style="width:30%; " class="control-label col-xs-4 no-padding-right"></label>
	        <div class="col-xs-3">
	            <div class="clearfix">
